...
data = {"weathre":{"value":wea},"temperature":{"value":temperature},"meet_days":{"value":get_meetdays()},"love_days":{"value":get_lovedays()},"words":{"value":get_words(), "color":get_random_color()}}
